...
public class AddCommentController implements Initializable {
    ...
    private void saveButtonPressed(ActionEvent event) {
        if (textTextField.getText() != null || video != null || image != null) {
            ...
            commentObject.setCommentMakerEmail(email);
            commentObject.setPostId(postId);
            if (textTextField.getText() != null) {
                commentObject.setCommentText(textTextField.getText());
            }
            if (image != null) {
                commentObject.setImageFile(image);
            }
            if (video != null) {
                commentObject.setVideoFile(video);
            }
            Bridge b = new Bridge(Commands.COMMENT_THIS, commentObject);
